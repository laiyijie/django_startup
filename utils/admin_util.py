...
def add_all_model_to_admin(app_name):
    ...
    for model_name, model in app.models.items():
        ...
        for field in model._meta.fields:
            t = type(field)
            if t == fields.IntegerField or t == fields.CharField or t == fields.FloatField or t == fields.TextField or t == fields.AutoField or t == fields.BigAutoField or t == fields.BigIntegerField:
                search.append(field.name)

        model_admin.search_fields = model.admin_search_fields if hasattr(model, 'admin_search_fields') else search
